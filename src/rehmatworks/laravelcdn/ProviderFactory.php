...
use Rehmatworks\laravelcdn\Exceptions\UnsupportedProviderException;
...
{
    const DRIVERS_NAMESPACE = 'Rehmatworks\\laravelcdn\\Providers\\';
     ...
     *
     * @throws \Rehmatworks\laravelcdn\UnsupportedDriverException
     *
     * @return mixed
     */
