...
use Rehmatworks\laravelcdn\Contracts\AssetInterface;
use Rehmatworks\laravelcdn\Contracts\CdnHelperInterface;
use Rehmatworks\laravelcdn\Contracts\CdnInterface;
use Rehmatworks\laravelcdn\Contracts\FinderInterface;
...
class Cdn implements CdnInterface
{
     ...
     *
     * @internal param \Rehmatworks\laravelcdn\Repository $configurations
     */
    ...
    /**
     * Will be called from the Rehmatworks\laravelcdn\PushCommand class on Fire().
     */
    ...
    /**
     * Will be called from the Rehmatworks\laravelcdn\EmptyCommand class on Fire().
     */
